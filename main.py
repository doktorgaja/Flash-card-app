...
button_y = Button(image=button_y_image, highlightthickness=0, command=is_known)
button_y.grid(column=1, row=1)

button_x_image = PhotoImage(file="images/wrong.png")
button_x = Button(image=button_x_image, highlightthickness=0, command=display_french_words)
